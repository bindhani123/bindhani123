            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li class="active"><a  data-toggle="tab" href="#driver"><i class="fa fa-motorcycle"></i>Driver</a>
                        </li>
                    ...
                    <div class="tab-content custom-menu-content">
                        ...
                        <div id="driver" class="tab-pane active notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                <li><a href="driverreport.php" style="color: red"><b><u>Accomplishment Report</u></b></a>
                                </li>
                                    ...
                                    <div class="modal-dialog modals-default">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <h2 align="center">Add Driver Accomplishment</h2>
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <div class="col-lg-7 col-md-4 col-sm- col-xs-4">
                                                   ...
                                                   <div class="col-lg-5 col-md-4 col-sm- col-xs-4">
                                                            <div class="form-group ic-cmp-int">
                                                                ...
                                                                <div class="nk-int-st"><p style="margin-top: -20%; font-size: 10px">Total Amount(Driver's Fee).</p>
                        ...
                        <div class="table-responsive">
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Data</td>
                                        <td><b style="color: blue"><i>2,304.00</i></b></td>
