                    ...
                    <div class="tab-content custom-menu-content">
                        <div id="info" class="tab-pane active notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                ...
                                <li ><a href="customerinfo.php" style="color: red"><b><u>Customer</u></b></a>
                                </li>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="col-lg-6 col-md-4 col-sm- col-xs-4">
                                                            <div class="form-group ic-cmp-int">
                                                                ...
                                                                <div class="nk-int-st">
                                                                    <input class="form-control" placeholder="Enter Customer Address" type="text">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="table-responsive">
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Jhon Vincent</td>
                                        <td>Katalbas Street, Pob II</td>
                                        <td>Sagay City</td>
                                        <td><small>6122</small></td>
                                        <td><i>+6399845676</i></td>
                                        <td>Ktb 564 St. Jahan</td>
                                        <td><button class="btn btn-primary btn-xs">Data</button></td>
