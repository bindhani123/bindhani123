                    ...
                    <div class="tab-content custom-menu-content">
                        <div id="info" class="tab-pane active notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                <li class="active"><a href="driverinfo.php">Driver</a>
                                </li>
                                <li ><a href="customerinfo.php">Customer</a>
                                </li>
                                <li><a href="shipperinfo.php">Shipper</a>
                                </li>
                                <li><a href="vehicleinfo.php"  style="color: red"><b><u>Vehicle</u></b></a>
                                </li>
                            </ul>
                        </div>
                                                ...
                                                <div class="col-lg-6 col-md-4 col-sm- col-xs-4">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-5 col-md-4 col-sm- col-xs-4" style="margin-left: -6%">
                                                            ...
                                                            <div class="nk-int-st"><p style="margin-top: -9%; font-size: 10px">Plate Expiry.</p>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4 col-md-4 col-sm- col-xs-4" >
                                                            ...
                                                            <div class="nk-int-st"><p style="margin-top: -9%; font-size: 10px">Last Inspection Date</p>
                                                            <input class="form-control" placeholder="" type="date" style="margin-top: -10%">
                                                                </div>
                                                            </div>
                                                        </div>
                        ...
                        <div class="table-responsive">
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Jhon Vincent</td>
                                        <td><b style="color: blue">Rusi 123-ktc</b></td>
                                        <td>Data Fuel</td>
                                        <td><small>ZAW-7THHY</small></td>
                                        <td><i>December 01, 2021</i></td>
                                        <td>500kg.</td>
                                        <td>250</td>
