            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li class="active"><a  href="usermanagement.php"><i class="fa fa-user-secret"></i>User Management</a>
                        </li>
                    ...
                    <div class="data-table-list">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-4 col-sm- col-xs-4">
                                                            <div class="form-group ic-cmp-int">
                                                                ...
                                                                <div class="nk-int-st">
                                                                    <input class="form-control" placeholder="Firstname          -        Middlename         -         Lastname" type="text">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-6 col-md-4 col-sm- col-xs-4">
                                                   ...
                                                   <div class="col-lg-6 col-md-4 col-sm- col-xs-4">
                                                            <div class="form-group ic-cmp-int">
                                                                ...
                                                                <div class="nk-int-st">
                                                                    <input class="form-control" placeholder="Enter Contact Information" type="text">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="table-responsive">
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Jhon Karrie Hilomosa </td>
                                        <td>Ktb 564 St. Jahan</td>
                                        <td>Data</td>
                                        <td>Jhon11</td>
                                        <td>*******</td>
                                        <td><button class="btn btn-defualt btn-xs">Encoder</button></td>
                        ...
                        <button type="button" class="btn btn-danger waves-effect btn-sm" ><i class ="fa fa-trash"></i></button> 
                                    ...
                                    <tr>
                                        ...
                                        <td>Jhon11</td>
                                        <td>*******</td>
                                        <td><button class="btn btn-primary btn-xs">Admin</button></td>
